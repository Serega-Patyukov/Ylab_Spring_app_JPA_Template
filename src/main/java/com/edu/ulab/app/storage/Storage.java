...
@Slf4j
@Repository
public class Storage implements CrudRepository<UserEntity, Long>{
    ...
    private static Map<Long, BookEntity> storageBookEntities = new HashMap<>();

    // Хранилище юзеров. Ключи юзеров > 0.
    private static Map<Long, UserEntity> storageUserEntity = new HashMap<>();
    ...
    public void deleteById(Long id) {
        ...
        if (id < 0 && storageBookEntities.containsKey(id)) {
            ...
            long idUserEntity = storageBookEntities.get(id).getUserId();
